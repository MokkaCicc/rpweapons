...
public class DaggerItem extends ToolItem implements EnchantmentHandler {
    public final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public DaggerItem(ToolMaterial material, float attackDamage, float attackSpeed) {
    ...
    public boolean isInvalid(Enchantment enchantment) {
        return enchantment == Enchantments.SWEEPING || enchantment == Enchantments.KNOCKBACK;
    }
}
